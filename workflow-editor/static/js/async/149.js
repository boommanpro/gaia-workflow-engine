"use strict";
(self["webpackChunk_flowgram_ai_demo_free_layout"] = self["webpackChunk_flowgram_ai_demo_free_layout"] || []).push([["149"], {
4337: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  TypeScriptLanguageService: () => (TypeScriptLanguageService),
  typescript: () => (typescript),
  typescriptLanguage: () => (/* reexport safe */ _codemirror_lang_javascript__WEBPACK_IMPORTED_MODULE_2__.typescriptLanguage),
  typescriptLanguageService: () => (typescriptLanguageService)
});
/* ESM import */var _codemirror_lang_javascript__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4338);
/* ESM import */var vscode_uri__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3707);
/* ESM import */var vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2442);
/* ESM import */var mitt__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2435);
/* ESM import */var comlink__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4340);
/* ESM import */var _coze_editor_code_language_shared__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2441);
/* ESM import */var _codemirror_view__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(2418);
/* ESM import */var _codemirror_state__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2419);
// src/index.ts
...
function asCompletionItemKind(kind) {
  switch (kind) {
    ...
    case "keyword" /* keyword */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Keyword;
    ...
    case "parameter" /* parameterElement */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Variable;
    case "property" /* memberVariableElement */:
    case "getter" /* memberGetAccessorElement */:
    case "setter" /* memberSetAccessorElement */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Field;
    case "function" /* functionElement */:
    case "local function" /* localFunctionElement */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Function;
    ...
    case "index" /* indexSignatureElement */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Method;
    case "enum" /* enumElement */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Enum;
    case "enum member" /* enumMemberElement */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.EnumMember;
    case "module" /* moduleElement */:
    case "external module name" /* externalModuleName */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Module;
    case "class" /* classElement */:
    case "type" /* typeElement */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Class;
    case "interface" /* interfaceElement */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Interface;
    case "warning" /* warning */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Text;
    case "script" /* scriptElement */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.File;
    case "directory" /* directory */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Folder;
    case "string" /* string */:
      return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Constant;
  }
  return vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_0__.CompletionItemKind.Property;
}
...
var TypeScriptLanguageService = class {
  ...
  events = (0,mitt__WEBPACK_IMPORTED_MODULE_1__["default"])();
  triggerCharacters = [".", "'", '"'];
  ...
  onTextDocumentDidChange = (ctx) => {
    ...
    const uri = vscode_uri__WEBPACK_IMPORTED_MODULE_3__.URI.parse(textDocument.uri);
...
${tags}` : ""}`
    ...
    try {
      ...
      return diagnostics.map((d) => {
        ...
        if (d.reportsUnnecessary) {
          tags.push(_coze_editor_code_language_shared__WEBPACK_IMPORTED_MODULE_4__.MarkerTag.Unnecessary);
        }
        if (d.reportsDeprecated) {
          tags.push(_coze_editor_code_language_shared__WEBPACK_IMPORTED_MODULE_4__.MarkerTag.Deprecated);
        }
        return {
          from: d.start,
  ...
  doComplete = async (ctx) => {
    const uri = vscode_uri__WEBPACK_IMPORTED_MODULE_3__.URI.parse(ctx.textDocument.uri);
    const path = uri.fsPath;
    const worker = await this.synchronize([path]);
  ...
  async format(state, options = {}) {
    const { textDocument, originalRangeFor } = state.field(_coze_editor_code_language_shared__WEBPACK_IMPORTED_MODULE_4__.textDocumentField);
    const uri = vscode_uri__WEBPACK_IMPORTED_MODULE_3__.URI.parse(textDocument.uri);
    const path = uri.fsPath;
    const worker = await this.synchronize([path]);
  ...
  initialize(tsWorker, options) {
    this.worker = (0,comlink__WEBPACK_IMPORTED_MODULE_5__.wrap)(tsWorker);
...
var cmdKeyPressedState = _codemirror_state__WEBPACK_IMPORTED_MODULE_6__.StateField.define({
  create: () => false,
  update: (value, tr) => {
...
var setCmdKeyPressedEffect = _codemirror_state__WEBPACK_IMPORTED_MODULE_6__.StateEffect.define();
var cmdKeyEventPlugin = _codemirror_view__WEBPACK_IMPORTED_MODULE_7__.ViewPlugin.fromClass(
  class {
    dispose;
    constructor(view) {
...
var getTypeInformationFacet = _codemirror_state__WEBPACK_IMPORTED_MODULE_6__.Facet.define({
  combine(values) {
...
var tooltipTheme = _codemirror_view__WEBPACK_IMPORTED_MODULE_7__.EditorView.theme({
...
function typeInformation(getTypeInformation) {
  return [
    ...
    cmdKeyPressedState,
    cmdKeyEventPlugin,
    (0,_codemirror_view__WEBPACK_IMPORTED_MODULE_7__.hoverTooltip)(cmdHoverTooltipSource, {
      hoverTime: 300
    })
  ];
}
...
var extensions = [
  type_information_default(async (state, pos) => {
    const { textDocument, generatedRangeFor } = state.field(_coze_editor_code_language_shared__WEBPACK_IMPORTED_MODULE_4__.textDocumentField);
...
// src/index.ts
var typescript = {
  language: _codemirror_lang_javascript__WEBPACK_IMPORTED_MODULE_2__.typescriptLanguage,
...
4336: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  TypeScriptLanguageService: () => (/* reexport safe */ _coze_editor_code_language_typescript__WEBPACK_IMPORTED_MODULE_0__.TypeScriptLanguageService),
  typescript: () => (/* reexport safe */ _coze_editor_code_language_typescript__WEBPACK_IMPORTED_MODULE_0__.typescript),
  typescriptLanguage: () => (/* reexport safe */ _coze_editor_code_language_typescript__WEBPACK_IMPORTED_MODULE_0__.typescriptLanguage),
  typescriptLanguageService: () => (/* reexport safe */ _coze_editor_code_language_typescript__WEBPACK_IMPORTED_MODULE_0__.typescriptLanguageService)
});
/* ESM import */var _coze_editor_code_language_typescript__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4337);
// src/language-typescript.ts

//# sourceMappingURL=language-typescript.js.map

}),
4338: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* ESM import */var _lezer_javascript__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4339);
/* ESM import */var _codemirror_language__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2424);
/* ESM import */var _codemirror_state__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2419);
/* ESM import */var _codemirror_view__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2418);
/* ESM import */var _codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2452);
/* ESM import */var _lezer_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2417);
...
4335: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  TypeScriptLanguageService: () => (/* reexport safe */ _coze_editor_editor_language_typescript__WEBPACK_IMPORTED_MODULE_0__.TypeScriptLanguageService),
  typescript: () => (/* reexport safe */ _coze_editor_editor_language_typescript__WEBPACK_IMPORTED_MODULE_0__.typescript),
  typescriptLanguage: () => (/* reexport safe */ _coze_editor_editor_language_typescript__WEBPACK_IMPORTED_MODULE_0__.typescriptLanguage),
  typescriptLanguageService: () => (/* reexport safe */ _coze_editor_editor_language_typescript__WEBPACK_IMPORTED_MODULE_0__.typescriptLanguageService)
});
/* ESM import */var _coze_editor_editor_language_typescript__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4336);



}),
4339: (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  parser: () => (parser)
});
