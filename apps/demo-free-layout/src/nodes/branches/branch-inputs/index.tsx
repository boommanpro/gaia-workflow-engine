                  ...
                  <BranchHeader>
                    <BranchTitle>
                      {editingBranchIndex === branchIndex ? (
                        ...
                        >
                          {branch.value.title || `Branch ${branchIndex + 1}`}
                        </div>
                      )}
                    </BranchTitle>
                      ...
                      {({ field: conditionsField }) => (
                        <>
                          {conditionsField.map((conditionField, conditionIndex) => (
                            <Field<ConditionValue> key={conditionField.name} name={conditionField.name}>
                                ...
                                <FormItem name="if" type="boolean" required={true} labelWidth={40}>
                                  <div style={{ display: 'flex', alignItems: 'center' }}>
                                    <ConditionRow
                                      ...
                                      onChange={(v) => condition.onChange({ value: v, key: condition.value.key })}
                                    />
                                  ...
                                  <Feedback errors={conditionState?.errors} invalid={conditionState?.invalid} />
                                </FormItem>
                              )}
                            </Field>
                          ))}
