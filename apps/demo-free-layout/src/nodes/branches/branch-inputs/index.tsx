                                                ...
                                                {({field: conditionsField}) => (
                                                    <>
                                                        {conditionsField.map((conditionField, conditionIndex) => (
                                                            <Field<ConditionValue> key={conditionField.name}
                                                                                   name={conditionField.name}>
                                                                {({field: condition, fieldState: conditionState}) => (
                                                                    <FormItem name="if" type="boolean" required={true}
                                                                              labelWidth={40}>
                                                                        <div style={{
                                                                            display: 'flex',
                                                                            alignItems: 'center'
                                                                        ...
                                                                        <Feedback errors={conditionState?.errors}
